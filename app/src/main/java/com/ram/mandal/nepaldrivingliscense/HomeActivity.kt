...
import com.ram.mandal.nepaldrivingliscense.data.model.getNavigationItems
import com.ram.mandal.nepaldrivingliscense.data.network.ApiService
import com.ram.mandal.nepaldrivingliscense.ui.components.NavigationDrawerBody
import com.ram.mandal.nepaldrivingliscense.ui.components.NavigationDrawerHeader
import com.ram.mandal.nepaldrivingliscense.ui.routes.NavigationRoutes
import com.ram.mandal.nepaldrivingliscense.ui.screens.dastoor.DastoorScreen
import com.ram.mandal.nepaldrivingliscense.ui.screens.exam_center.ExamCenterScreen
import com.ram.mandal.nepaldrivingliscense.ui.screens.fines.FinesScreen
import com.ram.mandal.nepaldrivingliscense.ui.screens.home.HomeScreen
import com.ram.mandal.nepaldrivingliscense.ui.screens.links.LinksScreen
...
fun MainScreen() {
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
            topBar = {
                TopAppBar(
                    title = { Text("Digital Nepali Tools") },
                    navigationIcon = {
                        IconButton(onClick = {
            ...
            NavHost(
                ...
                composable(NavigationRoutes.dastoor) { DastoorScreen() }
                composable(NavigationRoutes.fines) { FinesScreen() }
                composable(NavigationRoutes.center) { ExamCenterScreen() }
                composable(NavigationRoutes.links) { LinksScreen() }
            }
        }
    }
}
...
fun BottomNavigationBar(navController: NavHostController) {
    val items = listOf(
        ...
        BottomNavItem(NavigationRoutes.dastoor, R.drawable.ic_service_charge),
        BottomNavItem(NavigationRoutes.fines, R.drawable.ic_fines),
        BottomNavItem(NavigationRoutes.center, R.drawable.ic_location),
